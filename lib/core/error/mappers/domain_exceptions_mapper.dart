...
class DomainErrorMapper {
  ...
  static DomainError mapUnknown(Exception e) => DomainError.unknown(message: e.toString());

  static DomainError mapHive(Exception e) => DomainError.hiveError(message: e.toString());
