...
class MockApiService extends Mock implements ApiService {
  ...
  late final ProductList _products;

  final _news = NewsList(
    count: 2,
    next: null,
    previous: null,
    results: [
  ...
  final _categories = CategoryList(
    count: 13,
    next: null,
    previous: null,
    results: [
  ...
  @override
  Future<Product> getProductById(int productId) async => _products.results
      .where((p) {
  ...
  @override
  Future<ProductList> searchProducts({String? name, String? subcategory, String? status, String? minPrice, String? maxPrice, String? searchTerm, String? ordering, int? page}) async {
